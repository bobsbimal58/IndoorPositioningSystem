...
public class Constants {
    ...
    public static final String FLOOR = "Mapid";
    public static final String COLXAXIS = "X_AXIS";
    public static final String COLYAXIS = "Y_AXIS";
    public static final String COLZAXIS = "Z_AXIS";
    public static final String MAPX = "X_CORD";
    public static final String MAPY = "Y_CORD";
