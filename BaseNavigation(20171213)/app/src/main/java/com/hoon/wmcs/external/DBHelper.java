...
import static com.hoon.wmcs.external.Constants.MAPXM;
import static com.hoon.wmcs.external.Constants.MAPYM;
...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db){
        String createTable =  "create table " + TABLE_NAME + " (FLOOR INTEGER, REFID INTEGER, COORX REAL, COORY REAL, COORXM REAL, COORYM REAL, BEACON TEXT, RSSI INTEGER)";
    ...
    public Cursor getSelectedData(float imuX, float imuY){
        ...
        String que = "SELECT * FROM BeaconData WHERE COORX BETWEEN '" +beaconXcorMin+"' AND '"+beaconXcorMax+"' "+ "AND " +"COORY BETWEEN '" +beaconYcorMin+"' AND '"+beaconYcorMax+"'";
    ...
    public Cursor getResult(){
        ...
        Cursor mag = db.rawQuery("SELECT * FROM " + TABLENAME + " WHERE COORX BETWEEN '" +xmin+"' AND '"+xmax+"' "+ "AND " +"COORY BETWEEN '" +ymin+"' AND '"+ymax+"' ",null);
    ...
    public long getMaxY(float imuX, float imuY) {
        ...
        float beaconYcorMax = imuY + limitY;
        SQLiteDatabase db = this.getReadableDatabase();
        final SQLiteStatement stmt = db.compileStatement("SELECT MAX(COORY) FROM BeaconData WHERE COORY BETWEEN '" + beaconYcorMin + "' AND '" + beaconYcorMax + "' ");
    ...
    public long getMaxX(float imuX, float imuY) {
        ...
        float beaconYcorMax = imuY + limitY;
        SQLiteDatabase db = this.getReadableDatabase();
        final SQLiteStatement stmt = db.compileStatement("SELECT MAX(COORX) FROM BeaconData WHERE COORX BETWEEN '" + beaconXcorMin + "' AND '" + beaconXcorMax + "' ");
